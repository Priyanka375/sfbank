...
<html lang="en">
  ...
  <body >
        ...
        <img src="images/ab21.jpg" id="menuBtn">
            <div class="container pt-3">
                <div class="row g-0 pt-5">
                    <div class=" ps-5 pt-5 mt-5 col-lg-5 ">
                        <img src="images/ab11.jpg" class="img-fluid">
                    </div>
                    <div class="col-lg-7 text-center py5">
                        <h1>Create New User</h1>
                        <form action="registration.php" method="post">
                                          <div class="offset-1 col-lg-10">
                                    <input type="text" id="name" name="name" class="inp px-3" placeholder="Username">
                                </div>

                                         
                            <div class="form-row pt-4">
                                <div class="offset-1 col-lg-10">
                                    <input name="email" id="email" type="email" class="inp px-3" placeholder="Email">
                                </div>
                            </div>
                            <div class="form-row pt-5 ">
                                <div  class="  offset-1 col-lg-10">
                                    <select  name="gender" id="gender" class="inp px-3 form-selec " aria-label="Default select example">
